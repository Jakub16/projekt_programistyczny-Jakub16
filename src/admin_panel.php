    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link active" href="admin_panel.php">Panel administratora</a>
            </div>
        </div>
    </div>
</nav>
...
<div class="grid-container" id="main-container">
    ...
    $sql = "SELECT blog.id as blog_id, user.id, username, content, is_public, author_id_fk, blog.creation_date FROM blog join user on user.id = blog.author_id_fk;";
